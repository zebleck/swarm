...
developer_agent = Agent(
    ...
    functions=[list_directory, read_file, edit_file, create_file, delete_file]
)
...
web_browser_agent = Agent(
    ...
    functions=[navigate_to_url, search_on_page, get_page_content, click_element, type_into_element, close_browser]
)
